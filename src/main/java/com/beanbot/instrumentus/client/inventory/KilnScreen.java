...
public class KilnScreen extends AbstractFurnaceScreen<KilnMenu> {
    ...
    private static final List<RecipeBookComponent.TabInfo> TABS = List.of(new RecipeBookComponent.TabInfo(Items.GLASS.asItem(), InstrumentusRecipeBookCategories.FIRING.get()));
