...
public class ModBlocks {
    ...
    public static final DeferredHolder<Block, CopperSoulFlameLight> COPPER_SOUL_FLAME_LIGHT = SOULCOPPER.register("copper_soul_fire_flame", () -> new CopperSoulFlameLight());
    public static final DeferredHolder<Block, CopperSoulCampfireBlock> COPPER_SOUL_CAMPFIRE = SOULCOPPER.register("copper_soul_campfire", () -> new CopperSoulCampfireBlock());
    ...
    public static final DeferredHolder<Block, CopperSoulTorchBlock> SOULCOPPER_TORCH = SOULCOPPER.register("copper_soul_torch", () -> new CopperSoulTorchBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TORCH).noCollission().instabreak().lightLevel(e -> 15).sound(SoundType.WOOD))); //(SimpleParticleType)ModParticles.COPPER_SOUL_FIRE_FLAME_PARTICLE.get())
    public static final DeferredHolder<Block, CopperSoulWallTorchBlock> SOULCOPPER_WALL_TORCH = SOULCOPPER.register("copper_soul_wall_torch", () -> new CopperSoulWallTorchBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WALL_TORCH).noCollission().instabreak().lightLevel(e -> 15).sound(SoundType.WOOD).dropsLike(SOULCOPPER_TORCH.get()))); //(SimpleParticleType)ModParticles.COPPER_SOUL_FIRE_FLAME_PARTICLE.get()
