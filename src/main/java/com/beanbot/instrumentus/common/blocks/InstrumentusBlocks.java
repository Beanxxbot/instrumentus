...
public class InstrumentusBlocks {
    ...
    public static final DeferredHolder<Block, StairBlock> CUT_SOULCOPPER_STAIRS = BLOCKS_REGISTER.register("cut_soulcopper_stairs", () -> new StairBlock(CUT_SOULCOPPER.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_STAIRS)));
    public static final DeferredHolder<Block, SlabBlock> CUT_SOULCOPPER_SLAB = BLOCKS_REGISTER.register("soulcopper_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB)));
    ...
    public static final DeferredHolder<Block, Block> CHISELED_SOULCOPPER = BLOCKS_REGISTER.register("chiseled_soulcopper", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CHISELED_COPPER)));
    public static final DeferredHolder<Block, Block> SOULCOPPER_BULB = BLOCKS_REGISTER.register("soulcopper_bulb", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GLOWSTONE)));
