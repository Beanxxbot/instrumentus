...
public class GeneratorBlockStates extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlock(ModBlocks.COPPER_SOUL_FLAME_LIGHT.get(), models().cubeAll(ModBlocks.COPPER_SOUL_FLAME_LIGHT.getId().getPath(), blockTexture(ModBlocks.COPPER_SOUL_FLAME_LIGHT.get())));
        simpleBlock(ModBlocks.SOULCOPPER_TORCH.get(), models().torch(ModBlocks.SOULCOPPER_TORCH.getId().getPath(), modLoc("block/copper_soul_torch")));
        horizontalBlock(ModBlocks.SOULCOPPER_WALL_TORCH.get(), models().torchWall(ModBlocks.SOULCOPPER_WALL_TORCH.getId().getPath(), modLoc("block/copper_soul_torch")), 90);
