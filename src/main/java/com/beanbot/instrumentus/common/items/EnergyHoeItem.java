...
public class EnergyHoeItem extends DiggerItem implements IItemLightningChargeable, IEnergyItem {
    public EnergyHoeItem(ToolMaterial toolMaterial, float attackDamageIn, float attackSpeedIn, Item.Properties properties) {
        super(toolMaterial, BlockTags.MINEABLE_WITH_HOE, attackDamageIn, attackSpeedIn, properties);;
    }
