...
public class ModItems {
    ...
    public static final Supplier<Item> WOODEN_KNIFE = UTILITIES.register("wooden_knife", () -> new KnifeItem(Tiers.WOOD, 1, -2.0f));
    public static final Supplier<Item> STONE_KNIFE = UTILITIES.register("stone_knife", () -> new KnifeItem(Tiers.STONE, 1, -2.0f));
    public static final Supplier<Item> IRON_KNIFE = UTILITIES.register("iron_knife", () -> new KnifeItem(Tiers.IRON, 1, -2.0f));
    public static final Supplier<Item> GOLDEN_KNIFE = UTILITIES.register("golden_knife", () -> new KnifeItem(Tiers.GOLD, 1, -2.0f));
    public static final Supplier<Item> DIAMOND_KNIFE = UTILITIES.register("diamond_knife", () -> new KnifeItem(Tiers.DIAMOND, 1, -2.0f));
    public static final Supplier<Item> NETHERITE_KNIFE = UTILITIES.register("netherite_knife", () -> new KnifeItem(Tiers.NETHERITE, 1, -2.0f));
