...
public class KilnMenu extends AbstractFurnaceMenu {
    public KilnMenu(int containerId, Inventory playerInventory) {
        super(InstrumentusMenus.KILN_MENU.get(), InstrumentusRecipes.FIRING.get(), InstrumentusRecipePropertySet.FIRING, RecipeBookType.valueOf("INSTRUMENTUS_FIRING"), containerId, playerInventory);
    }

    public KilnMenu(int containerId, Inventory playerInventory, Container kilnContainer, ContainerData kilnData) {
        super(InstrumentusMenus.KILN_MENU.get(), InstrumentusRecipes.FIRING.get(), InstrumentusRecipePropertySet.FIRING,RecipeBookType.valueOf("INSTRUMENTUS_FIRING"), containerId, playerInventory, kilnContainer, kilnData);
    }
}
